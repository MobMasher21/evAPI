...
namespace evAPI
{
  ...
  void button::setCallback(void (*callback)(int))
  { buttonCallback = callback; }

  void button::setButtonAlliance(allianceType alliance)
  { buttonAlliance = alliance; }

  allianceType button::getButtonAlliance()
  { return buttonAlliance; }
}