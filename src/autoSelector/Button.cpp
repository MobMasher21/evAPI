#include "evAPI/autoSelector/Button.h"
...
void Button::setButtonColor(vex::color colorInput) {  // Sets the button color to a vex color object
...
void Button::setBorderColor(vex::color colorInput) {  // Sets the border color to vex color object
...
void Button::drawButton(bool border) {  // Draws the button with the option of adding the borderButton
  ...
  Brain.Screen.setPenColor(vex::color::transparent);
