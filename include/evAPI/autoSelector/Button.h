...
class Button {
  public:
    ...
    void setButtonColor(vex::color colorInput);  // Sets the button color to a vex color object
    void setButtonColor(int r, int g, int b);    // Sets the button color to a RGB value
    void setBorderColor(vex::color colorInput);  // Sets the border color to vex color object
  ...
  private:
    ...
    vex::color buttonColor;                            // Color of the button
    vex::color buttonBorderColor = vex::color::white;  // Color of the button border Default: white
